...
import com.sabbir.admin.sabbirjsonpasingusingretfitbitcoinlist.adapter.CustomizedAdapter;
import com.sabbir.admin.sabbirjsonpasingusingretfitbitcoinlist.apiInterface.Api;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getALlData(int from,int limit) {
        ...
        Call<List<ProductDetails>> call = api.getHeroes(from,limit);
        ...
        call.enqueue(new Callback<List<ProductDetails>>() {
            ...
            public void onResponse(Call<List<ProductDetails>> call, Response<List<ProductDetails>> response) {
                List<ProductDetails> heroList = response.body();
